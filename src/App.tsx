...
export default function Portal() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center text-white relative overflow-hidden p-4 sm:p-6 font-['Segoe_UI',sans-serif]">
      {/* Background Decor */}
      <div className="absolute top-[-10%] left-[-10%] w-72 sm:w-96 h-72 sm:h-96 bg-emerald-500/10 rounded-full blur-[120px] animate-pulse"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-72 sm:w-96 h-72 sm:h-96 bg-blue-500/10 rounded-full blur-[120px] animate-pulse delay-700"></div>

      <div className="z-10 w-full max-w-[450px] px-1 sm:px-4 animate-fadeIn">
        
        {/* Brand block */}
        <div className="flex flex-col items-center mb-6 sm:mb-8 text-center">
          <div className="w-16 sm:w-20 h-16 sm:h-20 bg-white rounded-[20px] sm:rounded-[24px] flex items-center justify-center p-2 shadow-2xl mb-2 overflow-hidden transform hover:rotate-3 transition-transform">
            <img src={logoIem} alt="IEM Logo" className="w-full h-full object-contain" />
          </div>
          <h2 className="text-2xl sm:text-3xl font-black text-white tracking-widest uppercase mt-2 sm:mt-3">
            IEM
          </h2>
        </div>

        {/* Auth Card */}
        <div className="bg-white/5 border border-white/10 backdrop-blur-2xl p-5 sm:p-8 rounded-[24px] sm:rounded-[32px] shadow-[0_30px_70px_rgba(0,0,0,0.5)] space-y-5 sm:space-y-6">
