  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-700 pb-20">
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-10">
        <div>
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black tracking-tighter">Registration Hub</h2>
          <p className="text-xs text-slate-400 font-bold uppercase tracking-[0.3em] mt-2">Registration Service Suite</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[24px] sm:rounded-[32px] lg:rounded-[40px] p-5 sm:p-6 lg:p-8 shadow-premium border border-slate-100 dark:border-slate-800">
        ...
        <div className="max-h-[500px] overflow-y-auto pr-2 custom-scrollbar">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {students.map(s => (
              <div key={s.id} className="p-6 bg-slate-50 dark:bg-slate-800/50 rounded-[32px] flex items-center justify-between group">
