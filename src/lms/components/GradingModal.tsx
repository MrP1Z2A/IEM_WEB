                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3">
                      ...
                      <div className="flex-1 w-full relative">
                        <input aria-label="Action"
                          ...
                          className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-sm font-medium text-white focus:outline-none focus:border-[#4ea59d] transition-all placeholder:text-slate-500"
                        />
                      </div>
