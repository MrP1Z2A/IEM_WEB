              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2 md:col-span-2">
                  ...
                  <input aria-label="Action"
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white font-bold focus:border-[#4ea59d] transition-all outline-none placeholder:text-slate-500"
                  />
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  >
                    <option value="" className="bg-[#0a1a19] text-white">Select Evaluation Target</option>
                    {assignedCourses.map(c => (
                ...
                <div className="space-y-2">
                  ...
                  <input aria-label="Action" type="date" value={examDate} onChange={(e) => setExamDate(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white font-bold focus:border-[#4ea59d] transition-all outline-none [color-scheme:dark]" />
                </div>

                <div className="space-y-2">
                  <label className="text-[10px] font-black text-[#4ea59d] uppercase tracking-[0.2em]">Starting Time</label>
                  <input aria-label="Action" type="time" value={examTime} onChange={(e) => setExamTime(e.target.value)} className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white font-bold focus:border-[#4ea59d] transition-all outline-none [color-scheme:dark]" />
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <textarea aria-label="Action"
                    ...
                    className="w-full bg-white/5 border border-white/10 rounded-2xl px-6 py-4 text-white font-medium focus:border-[#4ea59d] transition-all outline-none resize-none placeholder:text-slate-500"
                  ></textarea>
                </div>
              </div>
