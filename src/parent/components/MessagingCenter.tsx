    ...
    <div className="space-y-6 animate-fadeIn pb-20">
      <div className="bg-white rounded-[2rem] border border-slate-200 shadow-sm p-6 md:p-8">
        ...
        <div className="mt-6 flex flex-wrap items-center gap-3">
          ...
          <button
            type="button" onClick={() => { void loadContacts(); void loadGroups(); }}
                  ...
                  {filteredGroups.length === 0 ? (
                    ...
                    filteredGroups.map((group) => {
                      ...
                      return (
                        <button
                          key={group.id}
                          type="button" onClick={() => setActiveChat({ kind: 'group', group })}
                      ...
                      {!isExpanded ? null : entries.length === 0 ? (
                        ...
                        entries.map((contact) => {
                          ...
                          return (
                            <button
                              key={contact.id}
                              type="button" onClick={() => setActiveChat({ kind: 'dm', contact })}
            ...
            <>
              <div className="p-5 border-b border-slate-200 bg-white flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button
                    type="button" onClick={() => setActiveChat(null)}
                            ...
                            >
                              {isDeleting ? (
                                <div className="flex items-center gap-3">
                                  ...
                                  <button
                                    type="button" onClick={() => void handleDeleteMessage(message.id)}
                                  ...
                                  <button
                                    type="button" onClick={() => setDeletingMessageId(null)}
                                ...
                                <>
                                  ...
                                  {isOwn && !isOptimistic && (
                                    <button
                                      type="button" onClick={() => setDeletingMessageId(message.id)}
        ...
        <div className="fixed inset-0 z-[120] bg-slate-900/55 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-lg bg-white rounded-[2rem] shadow-2xl border border-slate-200 overflow-hidden">
            <div className="px-6 py-5 border-b border-slate-200 flex items-center justify-between">
              ...
              <button type="button" onClick={() => setIsCreateGroupOpen(false)} className="w-10 h-10 rounded-xl bg-slate-100 text-slate-500 hover:text-slate-900 flex items-center justify-center transition-all">
                <X className="w-4 h-4" />
              </button>
            </div>
        ...
        <div className="fixed inset-0 z-[120] bg-slate-900/55 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="w-full max-w-md bg-white rounded-[2rem] shadow-2xl border border-slate-200 overflow-hidden">
            <div className="px-6 py-5 border-b border-slate-200 flex items-center justify-between">
              ...
              <button type="button" onClick={() => setIsAddMemberOpen(false)} className="w-10 h-10 rounded-xl bg-slate-100 text-slate-500 hover:text-slate-900 flex items-center justify-center transition-all">
                <X className="w-4 h-4" />
              </button>
            </div>
                  ...
                  {(activeChat.group.members || []).map((member) => (
                    <div key={member.user_id} className="inline-flex items-center gap-2 rounded-xl bg-slate-100 px-3 py-2">
                      ...
                      {activeChat.group.created_by === parentId && member.user_id !== parentId && (
                        <button
                          type="button" onClick={() => void handleRemoveMember(member.user_id)}
                ...
                {nonMembers.length === 0 ? (
                  ...
                  <div className="space-y-2 max-h-60 overflow-y-auto pr-1">
                    {nonMembers.map((contact) => (
                      <button
                        key={contact.id}
                        type="button" onClick={() => void handleAddMember(contact)}
